	...
	<div class="login">
		...
		<div class="login-wrapper">
			<div class="input-content">
				...
				<input type="text" placeholder="请输入用户名" class="input" v-model="user" ref="user">
				<img src="./delete.png" class="delete" v-show="user" @click="emptyUser">
			</div>
			<div class="input-content">
				<img src="./password.png" class="icon">
				<input type="password" placeholder="请输入密码" class="input" v-model="pwd" ref="pwd">
